...
/**************************************************************************************/
vt<ll> roomAllocation(ll n, vt<pair<ll, ll>>& stay){
    sort(all(stay)); // sort according to endings
    vt<ll> allocation(n);
...
void solve(){
    ll n;
    cin>>n;
    vt<pair<ll, ll>> stay(n);
    cin>>stay;
    vt<ll> res = roomAllocation(n, stay);
    cout<<res<<endl;
}
int main(){
    speed_;
